/**
 * Back side entry point
 * Viewer mode for Anki cards
 */
...
import { initViewerMode } from './viewer/viewer.js';
...
console.log('Back side loaded:', { config, state });
initViewerMode(config, state, null, null, {});
